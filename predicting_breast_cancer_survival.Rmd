...
# Stomach studies 
sum_frac_mut %>% ggplot(aes(nfrac, log(nmut), color = study)) + geom_point() + geom_label_repel(aes(label=ID, color = ifelse(grepl('Stomach', study), "red", "blue"))) + theme(legend.position = "none")
